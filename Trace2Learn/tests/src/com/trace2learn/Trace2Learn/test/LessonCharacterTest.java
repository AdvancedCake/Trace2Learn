...
public class LessonCharacterTest extends AndroidTestCase {
    ...
    public void testToXml() {
        ...
        c.addKeyValue("k1", "v1 & v2");
        c.addKeyValue("k2", "there's nothing here!");
        c.addStroke(s1);
        c.addStroke(s2);
        c.addStroke(s3);
        ...
        String exp = "<character id=\"myId\">\n" +
                "<tag tag=\"&quot;tag&quot;!\" />\n" +
                "<tag tag=\"another tag?\" />\n" +
                "<id key=\"k1\" value=\"v1 &amp; v2\" />\n" +
                "<id key=\"k2\" value=\"there&apos;s nothing here!\" />\n" +
                "<stroke position=\"0\">\n" +
    ...
    public void testImportFromXml() throws SAXException, IOException {
        ...
        exp.addKeyValue("k1", "v1 & v2");
        exp.addKeyValue("k2", "there's nothing here!");
        exp.addStroke(s1);
        exp.addStroke(s2);
        exp.addStroke(s3);
