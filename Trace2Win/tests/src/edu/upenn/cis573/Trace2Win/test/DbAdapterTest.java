...
public class DbAdapterTest extends AndroidTestCase {
	...
	public void testCreateWordKeyValues()
	{
		...
		db.addWord(w);
		db.createKeyValue(-1, w.getStringId(), w.getItemType(), "key1", "value1");
	...
	public void testCreateCharKeyValues()
	{
		LessonCharacter c = new LessonCharacter();
		db.addCharacter(c);
		db.createKeyValue(c.getId(), null, c.getItemType(), "key1", "value1");
	...
	public void testDeleteWordKeyValues()
	{
		...
		db.addWord(w);
		db.createKeyValue(-1, w.getStringId(), w.getItemType(), "key1", "value1");
		db.deleteKeyValue(-1, w.getStringId(), w.getItemType(), "key1");
		LessonWord w1 = db.getWordById(w.getStringId());
		LessonWordTest.compareWords(w, w1);
	}		
	...
	public void testDeleteCharKeyValues()
	{
		...
		db.addCharacter(c);
		db.createKeyValue(c.getId(), null, c.getItemType(), "key1", "value1");
		db.deleteKeyValue(c.getId(), null, c.getItemType(), "key1");
		LessonCharacter c1 = db.getCharacterById(c.getId());
		LessonCharacterTest.compareCharacters(c, c1);
	}	
	...
	public void testGetWordKeyValues()
	{
		...
		db.addWord(w);
		db.createKeyValue(-1, w.getStringId(), w.getItemType(), "key1", "value1");
		HashMap<String, String> keyValues = db.getKeyValues(-1, w.getStringId(), w.getItemType());
	...
	public void testGetCharKeyValues()
	{
		...
		db.addCharacter(c);
		db.createKeyValue(c.getId(), null, c.getItemType(), "key1", "value1");
		HashMap<String, String> keyValues = db.getKeyValues(c.getId(), null, c.getItemType());
    ...
    public void testSwapTagsCharacter() {
        ...
        db.swapTags1(DbAdapter.CHARTAG_TABLE, c.getId(), "1", "2");
    ...
    public void testSwapKeyValuesCharacter() {
        ...
        exp1.put("k1", "v1");
        exp1.put("k2", "v2");
        assertEquals(exp1, db.getKeyValues(c.getId(), null, LessonItem.ItemType.CHARACTER));
        assertEquals(exp1, c.getKeyValues());
        
        db.swapKeyValues1(DbAdapter.CHARKEYVALUES_TABLE, c.getId(), "k1", "k2");
        LinkedHashMap<String, String> exp2 = new LinkedHashMap<String, String>();
        exp2.put("k2", "v2");
        exp2.put("k1", "v1");
        assertEquals(exp2, db.getKeyValues(c.getId(), null, LessonItem.ItemType.CHARACTER));
    ...
    public void testSwapKeyValuesWord() {
        ...
        exp1.put("k1", "v1");
        exp1.put("k2", "v2");
        assertEquals(exp1, db.getKeyValues(-1, c.getStringId(), LessonItem.ItemType.WORD));
        assertEquals(exp1, c.getKeyValues());
        ...
        exp2.put("k2", "v2");
        exp2.put("k1", "v1");
        assertEquals(exp2, db.getKeyValues(-1, c.getStringId(), LessonItem.ItemType.WORD));
