...
public class IntroductionActivity extends TraceBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String narrative1  = "Learning to read and write Chinese has a lot to do with learning to recognize patterns.  "
        		...
        		+ "TraceMe!  is an innovative pattern-based system designed to help you quickly start to read and write.  "
        		...
        		+ "The collections offer one set of associations.  TraceMe! also encourages you to discover the associations that make sense to you, and lets you build your own collections.\n\n"
        ...
        String narrative2 = "\nA note on the style of characters used:  "
        		...
        		+ "This tool does not teach calligraphy.  What it will do is let you discover for yourself how characters are composed, and how they interact with each other.  "
